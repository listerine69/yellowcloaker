...
class Cloaker {
    public $os_white;
    public $country_white;
    public $lang_white;
    public $tokens_black;
    public $url_should_contain;
    public $ua_black;
    public $ip_black_filename;
    public $ip_black_cidr;
    public $block_without_referer;
    public $referer_stopwords;
    public $block_vpnandtor;
    public $isp_black;
    public $result = [];
    public $detect; // Declaração explícita da propriedade detect agora é public
    ...
    public function detect() {
        ...
        } elseif (isset($_COOKIE['referer']) && !empty($_COOKIE['referer'])) {
